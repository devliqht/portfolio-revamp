...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative bg-white dark:bg-black overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-[5.8%] sm:md:px-[2.7%] py-24 sm:py-32">
        {/* Main footer content */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl font-dm-sans font-light text-neutral-700 dark:text-neutral-300 max-w-lg leading-relaxed">
              ...
              <div className="flex gap-6">
                {[
                  ...
                  <a
                    ...
                    className="group p-3 rounded-full bg-neutral-100 dark:bg-neutral-900 hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-all duration-300 hover:scale-110"
                    aria-label={label}
                  >
