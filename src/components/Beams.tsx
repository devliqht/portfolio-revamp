...
const Beams: FC<BeamsProps> = ({
  ...
  const finalLightColor = lightColor || (isDark ? '#ffffff' : '#000000');
  const finalBeamColor = beamColor || (isDark ? '#000000' : '#ffffff');
  ...
  vec3 getNormal(vec3 pos) {
    ...
    gl_FragColor.rgb -= randomNoise / 15. * uNoiseIntensity;`,
        ...
        material: { fog: true },
        uniforms: {
          diffuse: new THREE.Color(...hexToNormalizedRGB(finalBeamColor)),
    ...
    [speed, noiseIntensity, scale, finalBeamColor]
  );
    ...
    <CanvasWrapper>
      <group rotation={[0, 0, degToRad(rotation)]}>
        <PlaneNoise
          ...
          height={beamHeight}
        />
        <DirLight color={finalLightColor} position={[0, 3, 10]} />
      </group>
